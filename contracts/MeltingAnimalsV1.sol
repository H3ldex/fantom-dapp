...
// Melting animal collection that will be your new favorite collection on Fantom
...
contract MeltingAnimalsV1 is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;
  
  string public baseExtension = ".json";
  uint256 public cost = 100; 
  uint256 public maxFREN = 304; 
  uint256 public maxFRENMintAmount = 17; 
  bool public paused = false;
  
  string public baseURI = "https://bafybeiefmgdbor7owl3udwtdndfdhzediijl3eqqmq5iswnnt6eiag3v44.ipfs.nftstorage.link/";
  

  constructor(
  ) ERC721("MeltingAnimals", "MELT")
  RandomlyAssigned(304, 1) {}
